 ...
 */
function inventreeropengineDashboardItem({
    context
}: {
    ...
    const pluginName : string = "inventreeropengine";
...
//  component
export function renderinventreeropengineDashboardItem(context: InvenTreePluginContext) {
    checkPluginVersion(context);
    return <inventreeropengineDashboardItem context={context} />;
}
