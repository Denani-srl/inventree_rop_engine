# inventree rop engine- Frontend Code

This directory contains the frontend code for the inventree rop engine plugin.
...
This will compile the frontend into the `../inventree_rop_engine/static` directory (ready for distribution).
